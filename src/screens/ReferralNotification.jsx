...
// Screen 1 of the care journey: a warm, reassuring referral notification.
// Personalised from HealthHub data when linked, with a manual fallback.
export default function ReferralNotification({
  ...
  const greetingName = patient.name?.trim() ? patient.name : 'there'
  ...
  return (
    <section className="screen">
      ...
      <div className="card">
        ...
        <h1 className="screen-title">Hello {greetingName}</h1>
        ...
        <p className="body-text">
          Based on this, your doctor has gently referred you to the{' '}
